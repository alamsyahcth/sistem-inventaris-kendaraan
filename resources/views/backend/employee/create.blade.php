        ...
        <div class="card-body">
          <form class="form-horizontal" action={{url('/manage/employee/store')}} method="post" enctype="multipart/form-data">
            ...
            <div class="form">
              ...
              <div class="form-group">
                <input type="text" name="birthday" class="form-control datepicker-employee @error('birthday') is-invalid @enderror" autocomplete="birthday" placeholder="Input tanggal lahir"/>
                @error('birthday')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
