    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/manage')}}">
          <img src="{{asset('img/icon/dashboard.svg')}}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/manage/vechile')}}">
          <img src="{{asset('img/icon/vechile.svg')}}">
          <span class="ml-2">Data Kendaraan</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{url('/manage/category')}}">
          <img src="{{asset('img/icon/category.svg')}}">
          <span class="ml-2">Data Kategori Kendaraan</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/manage/book')}}">
          ...
          <span class="ml-2">Peminjaman Berjalan</span>
        </a>
      </li>
      <li class="nav-item">
