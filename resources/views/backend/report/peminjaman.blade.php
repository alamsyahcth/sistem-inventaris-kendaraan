...
<div class="container-fluid my-4">
  <div class="row">
    <div class="col-md-12">
      <h1 class="font-weight-bold text-dark">Laporan Peminjaman</h1>
      <h6 class="mb-2">Cetak Laporan Peminjaman</h6>
    </div>
  </div>
</div>
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <form class="form-horizontal" method="post" action="{{ url('/manage/report-peminjaman/print') }}" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="submit" value="Cetak PDF" target="_blank" class="btn btn-danger btn-md btn-block mt-3">
                  </div>
                </div>
              </div>
            </div>
